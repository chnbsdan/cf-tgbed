      ...
      try {
        ...
        if (file) {
          ...
          if (file.storage_type === 'r2' && config.r2Bucket) {
            ...
            try {
              const filePath = file.fileId; // GitHub 存储的 fileId 就是路径
  ...
  <title>文件管理</title>
    <style>
      * { box-sizing: border-box; }
      ...
      .modal-close:hover { color: #ff6b6b; background: rgba(0,0,0,0.5); }
      #previewImage { 
        width: 100%;
        height: 100%;
        max-width: 100%;
