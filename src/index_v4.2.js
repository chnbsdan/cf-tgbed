...
function generateUploadPage() {
    ...
    <div class="container">
      ...
      <div class="toolbar">
        <div class="toolbar-group">
          <label><i class="fas fa-database"></i> 存储</label>
          <select id="storageMode">
            <option value="telegram">✈️ Telegram</option>
            <option value="r2">☁️ CF-R2</option>
  ...
  <label><i class="fas fa-folder"></i> 文件夹</label>
  <select id="folderSelect" style="padding:7px 12px;border-radius:10px;border:1px solid rgba(0,0,0,0.08);background:rgba(255,255,255,0.7);font-size:0.9em;cursor:pointer;min-width:120px;outline:none;">
    <option value="">📁 根目录</option>
  </select>
  <button type="button" id="createFolderBtn" style="padding:6px 14px;border-radius:8px;border:none;background:#4a6cf7;color:#fff;cursor:pointer;font-size:13px;font-weight:500;transition:all 0.2s;">
