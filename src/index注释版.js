...
// ============================================================
// 块 1: 数据库初始化
// 功能: 创建 files 表（文件元数据）和 users 表（用户信息）
// 注意: 只执行一次，后续请求跳过
// ============================================================
...
// ============================================================
// 块 2: 导出主函数（路由分发）
// 功能: 加载环境变量配置，根据 URL 路径分发到对应的处理函数
// 路由: /, /login, /register, /logout, /upload, /admin, /delete, /batch-delete, /search, /bing, /history, /favicon.ico, /admin/users/toggle-admin, /admin/users/toggle-active, /api/folders
// ============================================================
export default {
...
// ============================================================
// 块 3: 身份认证（Cookie 会话）
// 功能: 从 Cookie 中解析 auth_token，验证用户登录状态
// 返回: 用户名（string）或 false
// ============================================================
...
// ============================================================
// 块 6: 生成认证 Token
// 功能: 生成包含用户名和过期时间的 Base64 编码 Token
// ============================================================
...
// ============================================================
// 第 2 部分：登录 + 注册 + 退出 (8-11)
// 块 8: 登录处理
// 功能: POST 验证用户名密码，GET 返回登录页面
// 支持: 多用户（users 表）+ 兼容旧版 admin/admin
// ============================================================
...
// ============================================================
// 块 9: 用户注册处理
// 功能: POST 创建新用户（用户名至少3字符，密码至少6字符）
// ============================================================
...
// ============================================================
// 第 3 部分：GitHub 代理 + 上传 (12-13)
// 块 12: GitHub 代理（解决跨域和速率限制）
// 功能: 代理 GitHub 原始文件请求，避免 CORS 和 API 速率限制
// ============================================================
...
// ============================================================
// 块 13: GitHub 上传
// 功能: 通过 GitHub API 将文件上传到指定仓库
// 支持: 自动处理文件重名（获取 sha 后覆盖）
// ============================================================
...
// ============================================================
// 第 4 部分：核心上传处理 + 管理后台 (14-15)
// 块 14: 核心上传处理
// 功能: 处理文件上传，支持 Telegram / R2 / GitHub 三种存储
// 新增: 多用户隔离（user_id）、文件夹关联（folder_id）、存储空间统计
// ============================================================
...
// ============================================================
// 块 15: 管理后台
// 功能: 返回管理页面 HTML，包含文件列表、用户管理、文件夹筛选
// 注意: 普通用户只能看到自己的文件，管理员可以看到所有
// ============================================================
...
// ============================================================
// 第 5 部分：批量删除 + 搜索 + 历史 + 预览 (16-19)
// 块 16: 批量删除
// 功能: 接收 URL 列表，批量删除文件和数据库记录
// 支持: Telegram / R2 / GitHub 三种存储的同步删除
// ============================================================
...
// ============================================================
// 块 19: 文件预览 HTML
// 功能: 根据文件扩展名生成预览 HTML（图片/视频/音频/文件图标）
// ============================================================
...
// ============================================================
// 第 6 部分：文件访问 + 删除单个 + 工具函数 (20-23)
// 块 20: 文件访问（支持大文件流式传输和 Range 请求）
// 功能: 处理文件下载/预览，支持 Range 请求（视频拖拽播放）
// 缓存: 完整文件缓存 1 年
// ============================================================
...
// ============================================================
// 第 7 部分：Bing 壁纸 + Favicon + 管理员操作 + 文件夹管理 + 公共模板 (24-30)
// 块 24: Bing 每日壁纸
// 功能: 获取 Bing 每日壁纸图片列表（缓存 6 小时）
// ============================================================
...
// ============================================================
// 块 25: 网站图标（Favicon）
// 功能: 从指定 URL 获取 favicon.ico 并缓存 1 天
// ============================================================
...
// ============================================================
// 块 28: 文件夹管理 API
// 功能: GET 获取用户文件夹列表，POST 创建新文件夹
// 权限: 普通用户只能看到自己的，管理员看到所有
// ============================================================
...
// ============================================================
// 块 29: HTML 公共头部
// 功能: 所有页面共用的 <head> 内容（编码、视口、图标、Font Awesome）
// ============================================================
function headLinks() {
  return `
    <meta charset="UTF-8">
...
// ============================================================
// 第 8 部分：登录页面 + 上传页面 + 管理页面 (31-33)
// 块 31: 登录页面 HTML
// 功能: 返回登录页面的完整 HTML（毛玻璃风格）
// 包含: 登录表单、密码显示切换、背景图、错误提示
// ============================================================
...
// 块 32: 上传页面 HTML
// 功能: 返回上传页面的完整 HTML
// 包含: 拖拽上传、存储方式切换、WebP转换、文件夹选择、URL复制
// 注意: 此函数较长（~400行），建议单独维护
// ============================================================
...
// 块 33: 管理页面 HTML
// 功能: 返回管理页面的完整 HTML
// 包含: 文件列表、用户管理、文件夹筛选、批量操作、大图预览
// 注意: 此函数较长（~500行），建议单独维护
// ============================================================
